# Generated by Django 2.2.16 on 2020-09-23 16:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(choices=[('北京', '北京'), ('上海', '上海'), ('广州', '广州'), ('深圳', '深圳'), ('成都', '成都'), ('武汉', '武汉'), ('洛阳', '洛阳')], max_length=10, verbose_name='常居地')),
            ],
        ),
    ]
